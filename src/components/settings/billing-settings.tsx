...
const BillingSettings = async () => {
    ...
    const planFeatures = pricingCards.find((card) => {
        return card.title.toUpperCase() === plan
    })?.features
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-5 gap-10'>
            ...
            <div className='lg:col-span-2 flex justify-start lg:justify-center'>
                <Card className='border-dashed bg-cream border-gray-400 w-full cursor-pointer
                h-[270px] flex justify-center items-center'>
                        ...
                        <p className='text-sm font-light'>
                            {
                                ...
                                : "Perffect if you're just getting started with Corinna AI"
                            }
                        </p>
                    )
                })} */}